...
rewrites TCP/UDP packets' addresses and ports, while (optionally) combining
post-routing operations such as DecIPTTL, DropBroadcasts, FixIPSrc,
IPGWOptions, and IPFragmentation.
...
=a IPRewriter, TCPRewriter, IPAddrPairRewriter, IPRewriterPatterns,
RoundRobinIPMapper, FTPPortMapper, ICMPRewriter, ICMPPingRewriter */

class IPSynthesizer : public IPRewriter {
